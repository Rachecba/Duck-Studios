...
import { designMockup, marketingProjects, marketingServices, marketingTestimonials, softwarePortfolio, softwareProjects, softwareServices, softwareTestimonials } from "./utils/constants/constants"
import { designProjects, designServices, designTestimonials,grapichDesignPortfolio } from "./utils/constants/constants"
function Main() {
    ...
    return (
        <Routes>
            ...
            {/* <Route path="/portfolio/marketing" element={ <PortfolioList portfolio={}/>} /> */}
