...
function Services() {
    ...
    return (
        <Styled.Container>
            <Styled.SectionTitle>
                <h1>{t('ourServices.home.title')}</h1>
            </Styled.SectionTitle>
            <Styled.Title>
                <h1><span>{t('ourServices.home.weHave')}</span> {t('ourServices.home.whatYouNeed')}</h1>
            </Styled.Title>
            <Styled.Services>
                 <Styled.Background/>
                <Styled.CardsContainer>
                    <Styled.Card className="top-card">
                        ...
                        <h1>{t('ourServices.home.software.title')}</h1>
                        <p>{t('ourServices.home.software.description')}</p>
                    ...
                    <Styled.Card className="middle-card">
                        ...
                        <h1>{t('ourServices.home.marketing.title')}</h1>
                        <p>{t('ourServices.home.marketing.description')}</p>
                        <Button className="button">{t('global:global.btnSeeMore')}</Button>
                    </Styled.Card>
                    <Styled.Card className="end-card">
                        ...
                        <h1>{t('ourServices.home.graphicDesign.title')}</h1>
                        <p>{t('ourServices.home.graphicDesign.description')}</p>
                        <Button className="button">{t('global:global.btnSeeMore')}</Button>
                    </Styled.Card>
                </Styled.CardsContainer>
            </Styled.Services>
